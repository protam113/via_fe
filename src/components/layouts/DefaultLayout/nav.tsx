...
const navItemsMobile = [
  { name: 'About Us', path: '/about' },
  { name: 'Via Art Fair', path: '/via-art-fair' },
  { name: 'Via Atelier', path: '/our-team' },
  { name: 'Via Atelier', path: '/via-atelier' },
];
        ...
        <div className="fixed inset-0 bg-white z-50 p-6 md:hidden">
          <div className="flex justify-between items-center mb-12">
            ...
            <div className="flex items-center gap-2">
              {/* <div className="w-8 h-8 ounded-full flex items-center justify-center">
                <CustomImage
                  src="/icons/Logo_noTitle.svg"
                  alt="Logo"
                  fill
              ...
              <div className="flex flex-col">
                <span className="text-base leading-none font-semibold uppercase">
